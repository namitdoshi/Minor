...
if($r->num_rows>0){
		...
		echo 'window.location.href = "../src/doctor/docSignup.html";';
		echo '</script>';
}
...
elseif($r6->num_rows>0){
		echo '<script type="text/javascript">'; 
		echo 'alert("Aadhar no is already registered");'; 
		echo 'window.location.href = "../src/doctor/docSignup.html";';
		echo '</script>';
}
...
// if(($type1=="image/jpeg") || ($type1=="image/jpg") || ($type1=="image/png")){
	...
	// 	echo 'window.location.href = "../src/docSignup.html";';
	// 	echo '</script>';
	// }
	elseif($cat == "Choose"){
		echo '<script type="text/javascript">'; 
	...
	elseif($cat!="Medical Specialization") {
	...
	// 	$location2 = "./verify/$docid/docs/";
		...
		echo '<script type="text/javascript">'; 
		echo 'alert("Doctor Registration successful");'; 
...
// 		echo 'window.location.href = "../src/patientSignup.php";';
// 		echo '</script>';
// }
}
}
