...
<head>
  ...
  <div class="container">
    ...
    <?php
		include('../../includes/conn.php');
		$q1 = "SELECT * FROM appointments where a_date>=CURRENT_DATE AND a_time>CURRENT_TIME AND status='pending' AND tid='' AND pat_id='$id'";
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <p>Doctor's Phone: <?php echo $ph;?></p>
                <p>Patient's Name: <?php echo $newname;?></p>  
              </div> 
              <a class="btn btn-indigo" href="./payment.php?payid=<?php echo $row['id'];?>"  onclick=""><i class="fas fa-rupee-sign"></i> Make Payment</a>  
            </div>
            </div>
          </div>
          <!-- Card --> 
