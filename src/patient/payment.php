...
<html lang="en">
  ...
  <br>
	...
	<h4 align="center" style="font-family;calibri;"><img width="80px" src="../../assets/img/mc.png"/>Secure Pay</h4><br>
	...
	<input type="text" disabled class="form-control" value="Rs. 500"/><br>
