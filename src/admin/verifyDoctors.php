...
?>
    <div class="" style="padding-bottom:20px;">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <!-- Title -->
          <h4 class="card-title">Doctor ID: <?php echo $row['did']; ?></h4>
          <div class="row">
            <div class="col-sm-6">
              <p>Doctor's Name: <?php echo $row['name']; ?></p>
              <p>Email: <?php echo $row['email']; ?></p>
            </div>
            <div class="col-sm-6">
              <p>Specialisation: <?php echo $row['specialist']; ?></p> 
              <p>Status: <?php echo $row['status']; ?></p>
            </div> 
            <a class="btn btn-indigo" href="./verify.php?did=<?php echo $row['did'];?>"  onclick="return confirm('Are you sure you want to mark this profile as verified?')">Verify Doctor <i class="fas fa-check-circle"></i></a>  
          </div>
        </div>
      </div>
      <!-- Card --> 
